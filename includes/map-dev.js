...
function write_streams_heatmap2() {
...
// @todo development only
function write_streams_heatmap3() {
    let obj = dtStreamsMetrics
    let chart = jQuery('#chart')
...
// @todo development only
function write_streams_heatmap4() {
    let obj = dtStreamsMetrics
    let chart = jQuery('#chart')
...
//                             if ( dtStreamsMetrics.data[geojson.features[i].properties.id] ) {
//                                 geojson.features[i].properties.value = parseInt( dtStreamsMetrics.data[geojson.features[i].properties.id].count )
//                             } else {
...
function contacts_map() {
    ...
    jQuery.ajax({
        ...
        dataType: "json",
        url: dtStreamsMetrics.root + 'dt/v1/streams/contacts_map/',
            ...
            map.on('load', function() {
                ...
                map.on('click', 'unclustered-point', function(e) {
                    ...
                    jQuery.ajax({
                        ...
                        url: dtStreamsMetrics.root + 'dt-posts/v2/contacts/',
                        beforeSend: function(xhr) {
                            xhr.setRequestHeader('X-WP-Nonce', dtStreamsMetrics.nonce);
                        },
                    })
...
// @todo development only
function write_streams_overview() {
    let obj = dtStreamsMetrics
    let chart = jQuery('#chart')
