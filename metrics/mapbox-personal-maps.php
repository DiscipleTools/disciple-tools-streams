...
class DT_Metrics_Mapbox_Personal_Streams_Maps extends DT_Metrics_Chart_Base
{
    ...
    public $title;
    public $slug = 'personal_streams'; // lowercase
...
new DT_Metrics_Mapbox_Personal_Streams_Maps();
