...
class DT_Metrics_Mapbox_Streams_Maps extends DT_Metrics_Chart_Base
{
    ...
    public $title;
    public $slug = 'mapbox_streams_maps'; // lowercase
    ...
    public $namespace = 'dt-metrics/streams/';
    public $base_filter = [];
    ...
    public function __construct() {
        ...
        $this->title = __( 'Stream Maps', 'disciple_tools' );
...
new DT_Metrics_Mapbox_Streams_Maps();
