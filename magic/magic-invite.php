...
class DT_Streams_Invite_To_Join_Stream extends DT_Magic_Url_Base {
            ...
            jQuery(document).ready(function($){
                ...
                function build_modal(){
                    ...
                    $('#content').empty().html(`
                        ...
                        <div id="send-panel" class="send not-new not-first">
                            <div class="grid-x">
                                <div class="cell">
                                    <label for="email">Email</label>
    ...
    /* public function body(){
        DT_Mapbox_API::geocoder_scripts();
        $parts = $this->parts;
        $name = get_the_title( $parts['post_id'] );
        ?>
        <style>
            body {
        ...
        <div id="magic-link-wrapper">
            <div class="grid-x grid-padding-x grid-padding-y">
                <div class="cell center">
                    <h2 id="title">Join the Reporting Team</h2>
                    You have been invited to participate in the reporting of the <?php echo $name ?> stream.
                </div>
            </div>
            <hr>
            <div class="grid-x">
